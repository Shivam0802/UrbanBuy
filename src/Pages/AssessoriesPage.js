...
import { Accessories } from "../StaticData/staticData";
                                ...
                                Accessories.map((item) => {
                                    return (
                                        <label key={item.id} className="flex flex-row items-center gap-2">
                                            <Link to={`/assessories/${item.desc}`} className="h-4 w-full flex flex-row gap-2 items-center hover:text-red-300">
                    ...
                    <div className="flex flex-col p-2">
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="flex flex-row items-center gap-2">
                                ...
                                <span className={`${darkTheme ? 'text-white' : 'text-black'}`}>Dell</span>
                            </label>
                            <label className="flex flex-row items-center gap-2">
                                <input type="checkbox" className="h-4 w-4" />
                                <span className={`${darkTheme ? 'text-white' : 'text-black'}`}>HP</span>
                            </label>
                            <label className="flex flex-row items-center gap-2">
                                <input type="checkbox" className="h-4 w-4" />
                                <span className={`${darkTheme ? 'text-white' : 'text-black'}`}>Lenevo</span>
                            </label>
                            <label className="flex flex-row items-center gap-2">
                                <input type="checkbox" className="h-4 w-4" />
                                <span className={`${darkTheme ? 'text-white' : 'text-black'}`}>Asus</span>
                            </label>
                            <label className="flex flex-row items-center gap-2">
                                <input type="checkbox" className="h-4 w-4" />
                                <span className={`${darkTheme ? 'text-white' : 'text-black'}`}>Acer</span>
                            </label>
                            <label className="flex flex-row items-center gap-2">
                                <input type="checkbox" className="h-4 w-4" />
                                <span className={`${darkTheme ? 'text-white' : 'text-black'}`}>Microsoft</span>
                            </label>
                        </div>
                    </div>
                </div>
